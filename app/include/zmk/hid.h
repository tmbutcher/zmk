...
#define ZMK_HID_KEYBOARD_NKRO_MAX_USAGE HID_USAGE_KEY_KEYPAD_EQUAL  // Maybe comment out?
...
#error "A proper consumer HID report usage range must be selected"
    ...
    HID_REPORT_COUNT(CONFIG_ZMK_HID_CONSUMER_REPORT_SIZE), // This line and the next three may need commenting out
    /* INPUT (Data,Ary,Abs) */
    HID_INPUT(0x00),
    /* END COLLECTION */
    HID_END_COLLECTION,
